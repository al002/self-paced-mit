...
def get_available_letters(letters_guessed):
    ...
    returns: string (of letters), comprised of letters that represents which letters have not
      yet been guessed.
    '''
    availabele_letters = string.ascii_lowercase
    for l in letters_guessed:
        availabele_letters.replace(l, '')

    return availabele_letters
...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while (guesses_remaining > 0 and not is_word_guessed(secret_word, letters_guessed)):
        ...
        if guessed.isalpha():
            if guessed in secret_word:
                ...
                if not guessed in letters_guessed:
                    if guessed in VOWELS:
                        guesses_remaining -= 2
                    else:
                        guesses_remaining -= 1
            ...
            if warnings_remaining > 0:
                ...
                print(f"so you lose one guess: {guessed_word}")
                guesses_remaining -= 1
    ...
    if guesses_remaining <= 0:
        ...
        total_score = guesses_remaining * len(''.join(set(secret_word)))
